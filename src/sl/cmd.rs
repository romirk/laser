...
const SL_LIDAR_CONF_SCAN_MODE_COUNT: u32 = 0x00000070;
const SL_LIDAR_CONF_SCAN_MODE_US_PER_SAMPLE: u32 = 0x00000071;
const SL_LIDAR_CONF_SCAN_MODE_MAX_DISTANCE: u32 = 0x00000074;
const SL_LIDAR_CONF_SCAN_MODE_ANS_TYPE: u32 = 0x00000075;
const SL_LIDAR_CONF_LIDAR_MAC_ADDR: u32 = 0x00000079;
const SL_LIDAR_CONF_SCAN_MODE_TYPICAL: u32 = 0x0000007C;
const SL_LIDAR_CONF_SCAN_MODE_NAME: u32 = 0x0000007F;
...
struct SlLidarResponseGetLidarConf {
    _type: u32,
    payload: [u8; 0],
}
